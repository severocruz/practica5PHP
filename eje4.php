...
<body>
  ...
  <div id="menu">
  	<UL>
		...
		<li><span class="elegido"><a href="eje4.php">Ejercicio 4</a></span></li>
  ...
  <div id="contenido"><p class="enunciado">Considerando el ejercicio 3. En el lugar del número escribir el número elevado al cuadrado.</p>
<?php
define("tam",8);
$c=1;
?>
...
<?php for ($i=1; $i <= tam ; $i++) { 
	...
	for ($j=1; $j <=tam ; $j++) { 
		if($c%2==0)
		{
			echo "<td class='casilla-negra'>".pow(tam,2)."</td>";
		}
		else
		{
		  echo "<td class='casilla'>".pow(tam,2)."</td>";# code...	
		}
