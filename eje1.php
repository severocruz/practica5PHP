...
<body>
  ...
  <div id="menu">
  	<UL>
		<li><span class="elegido"><a href="eje1.php">Ejercicio 1</a></span></li>
  ...
  <div id="contenido"><p class="enunciado">Mostrar en pantalla una tabla de 10 x 10 con los números del 1 al 100</p>
 <?php
define("tam",10);
$c=1;
?>
